...
// Componente ProductCard (El mismo que estaba fuera de la función App())
...
// Componente HomePage (Reemplaza a la antigua función App())
function HomePage() {
  ...
  return (
    <div className="HomePage"> {/* Cambié App a HomePage para semántica */}
      <Header />
